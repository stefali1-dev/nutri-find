    ...
    if (isSubmitted) {
        return (
            <div className={`bg-green-50 border border-green-200 rounded-lg p-4 sm:p-6 text-center ${className}`}>
                ...
                <h3 className="text-base sm:text-lg font-semibold text-green-800 mb-2">Bine ai venit în echipa NutriFind!</h3>
                <p className="text-sm sm:text-base text-green-700">
                    Te-ai înscris cu succes! Vei primi acces prioritar la clienții potențiali și listare gratuită.
                </p>
            </div>
        )
    }
        ...
        <div className={`bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl ${className}`}>
            <div className="text-center mb-4 sm:mb-6">
                ...
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 mb-2 px-2">
                    Listare <span className="text-green-600"> gratuită</span> pe platformă!
                </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                ...
                <div className="text-[11px] sm:text-xs text-gray-500 text-center space-y-1 px-2">
                    <p className="flex items-start justify-center">
                        <span className="text-green-600 mr-1 flex-shrink-0">✅</span>
                        <span className="text-left max-w-[280px] sm:max-w-none">Primești acces prioritar la cererile venite de la primii clienți care caută un nutriționist potrivit</span>
                    </p>
                    <p className="flex items-start justify-center">
                        <span className="text-green-600 mr-1 flex-shrink-0">✅</span>
                        <span className="text-left max-w-[280px] sm:max-w-none">Ești liber(ă) să te retragi oricând. Nu există nicio obligație, iar listarea e complet gratuită</span>
                    </p>
                </div>
            </form>
        </div>
...
export default function NutritionistsPage() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Inițial, gestionezi plățile direct cu clienții tăi (transfer bancar, cash, etc.). În viitor, vom oferi și opțiuni de plată prin platformă."
        },
        {
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Dezvoltă-ți practica de nutriție cu NutriFind. Listare gratuită, găsește clienți noi și gestionează programările fără taxe." />
            ...
            <div className="min-h-screen bg-white">
                            ...
                            <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                                <div className="animate-fade-in">
                                    ...
                                    <p className="mt-4 text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-2">
                                        ...
                                        <strong> Listare gratuită</strong> - construiește-ți portofoliul, stabilește-ți propriile prețuri și dezvoltă-ți afacerea în propriul ritm.
                                    </p>
                ...
                <section id="waitlist-hero" className="py-12 sm:py-16 bg-gradient-to-r from-green-500 to-emerald-600">
                    <div className="max-w-4xl mx-auto px-4">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-10">
                            <div className="text-white lg:w-1/2">
                                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">
                                    Fii printre primii nutriționiști pe platformă!
                                </h2>
                                <div className="space-y-2 sm:space-y-3">
                                    <div className="flex items-center text-green-100">
                                        ...
                                        <span className="text-sm sm:text-base">Listare și promovare gratuită</span>
                                    </div>
                                    <div className="flex items-center text-green-100">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        <span className="text-sm sm:text-base">Suport dedicat pentru configurarea profilului</span>
                                    </div>
                                    <div className="flex items-center text-green-100">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        <span className="text-sm sm:text-base">Acces prioritar la primii clienți înregistrați</span>
                                    </div>
                                </div>
                            </div>
                ...
                {/* <section id="insights" className="py-16 sm:py-20 bg-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center mb-12 sm:mb-16">
                            <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-3 sm:mb-4">Ce ne spun nutriționiștii</h2>
                            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg border">
                                <div className="flex items-center mb-4">
                                    ...
                                    />
                                    <div className="ml-3">
                                        <p className="font-semibold text-sm sm:text-base">Ana, 29 ani</p>
                                        <p className="text-xs sm:text-sm text-gray-500">Nutriționist Dietetician</p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg border">
                                <div className="flex items-center mb-4">
                                    ...
                                    />
                                    <div className="ml-3">
                                        <p className="font-semibold text-sm sm:text-base">Mihaela, 34 ani</p>
                                        <p className="text-xs sm:text-sm text-gray-500">Nutriționist Dietetician</p>
                                    </div>
                                </div>
                                <p className="text-sm sm:text-base text-gray-600 italic">
                            ...
                            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg border">
                                <div className="flex items-center mb-4">
                                    ...
                                    />
                                    <div className="ml-3">
                                        <p className="font-semibold text-sm sm:text-base">Laura, 26 ani</p>
                                        <p className="text-xs sm:text-sm text-gray-500">Absolventă</p>
                                    </div>
                                </div>
                                <p className="text-sm sm:text-base text-gray-600 italic">
                        ...
                        <div className="mt-8 sm:mt-12 bg-gray-50 p-6 sm:p-8 rounded-xl max-w-4xl mx-auto">
                            <div className="text-center">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 text-left">
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <p className="font-medium text-gray-800 text-sm sm:text-base">Dificultatea în găsirea clienților</p>
                                            <p className="text-xs sm:text-sm text-gray-600">Mulți nutriționiști cheltuie prea mult timp cu marketingul</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="bg-red-100 p-2 rounded-full mr-3 mt-0.5 flex-shrink-0">
                                        ...
                                        <div>
                                            <p className="font-medium text-gray-800 text-sm sm:text-base">Gestionarea administrativă</p>
                                            <p className="text-xs sm:text-sm text-gray-600">Programări, facturi și comunicare dezorganizate</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="bg-red-100 p-2 rounded-full mr-3 mt-0.5 flex-shrink-0">
                                        ...
                                        <div>
                                            <p className="font-medium text-gray-800 text-sm sm:text-base">Construirea credibilității</p>
                                            <p className="text-xs sm:text-sm text-gray-600">Greu să demonstrezi expertiza fără un portofoliu solid</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start">
                                        <div className="bg-red-100 p-2 rounded-full mr-3 mt-0.5 flex-shrink-0">
                                        ...
                                        <div>
                                            <p className="font-medium text-gray-800 text-sm sm:text-base">Venituri inconsistente</p>
                                            <p className="text-xs sm:text-sm text-gray-600">Lipsă de predictibilitate în numărul de clienți</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <section id="waitlist-final" className="py-16 sm:py-20 bg-gradient-to-br from-green-600 to-emerald-700">
                    <div className="max-w-6xl mx-auto px-4">
                        <div className="text-center mb-8 sm:mb-12">
                            ...
                            <p className="text-lg sm:text-xl text-green-100 mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
                                Alătură-te primilor nutriționiști pe platformă și beneficiază de listare gratuită plus promovare prioritară
                            </p>
                        ...
                        <div className="text-center mt-6 sm:mt-8">
                            <div className="grid grid-cols-3 gap-4 sm:gap-6 max-w-lg sm:max-w-3xl mx-auto">
                                <div className="text-green-100">
                                    <div className="text-xl sm:text-2xl font-bold">100%</div>
                                    <div className="text-xs sm:text-sm">gratuit acum</div>
                                </div>
                                <div className="text-green-100">
                                    <div className="text-xl sm:text-2xl font-bold">0</div>
                                    <div className="text-xs sm:text-sm">taxe de lansare</div>
                                </div>
                                <div className="text-green-100">
                                    <div className="text-xl sm:text-2xl font-bold">24/7</div>
                                    <div className="text-xs sm:text-sm">suport dedicat</div>
                                </div>
                            </div>
                        </div>
